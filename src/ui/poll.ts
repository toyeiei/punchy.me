...
<head>
    ...
    <meta property="og:description" content="Create lightning-fast polls. Share instantly. Auto-expires in 24 hours.">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Lightning-fast poll generator. Create, share, collect votes. Auto-expires in 24 hours.",
...
<body>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            let html = '<div style="color: var(--text-main); font-size: 1.1rem; font-weight: 700; margin-bottom: 1.5rem;">' + (q || 'Your question...') + '</div>';
...
export function generatePollVoteHTML(pollId: string, question: string, options: string[], votes: number[], totalVotes: number, hasVoted: boolean): string {
    ...
    options.forEach((opt, i) => {
        ...
        optionsHtml += `
            <div class="option-vote" data-index="${i}">
...
<head>
    ...
    <link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext y='.9em' font-size='90'%3E🗳️%3C/text%3E%3C/svg%3E">
    <meta property="og:title" content="${escapeHtmlSimple(question)}">
    <meta property="og:description" content="Vote now on POLL PUNCH">
